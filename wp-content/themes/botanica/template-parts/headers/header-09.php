...
?>
<header id="rbb-default-header" class="rbb-default-header header-9 lg:absolute w-full z-20">
	<div class="rbb-header-sticky relative md:block hidden bg-[color:var(--rbb-header-background-color)]">
		<div class="header-inner mx-auto h-[90px] px-5 2xl:px-[30px]">
			<div class="flex flex-nowrap items-center h-full grid grid-cols-8 md:gap-4">
				<div class="rbb-header-left lg:col-span-3 col-span-3 md:-mr-9 lg:block hidden">
					<?php
					$sidebar_active = is_active_sidebar('sidebar-header9-top');
					if ( $sidebar_active ) {
						dynamic_sidebar('sidebar-header9-top'); }
					?>
				</div>
				<?php
				if ( Helper::show_logo() ) {
					?>
					<div id="rbb-branding" class="rbb-branding rbb-header-center md:flex md:items-center lg:justify-center lg:text-center lg:col-span-2 col-span-4">
						<span class="toggle-megamenu w-[18px] h-[14px] relative mr-5 cursor-pointer lg:hidden">
							<i class="icon-directional"></i>
						</span>
						<div id="_desktop_logo" class="flex">
		...
		<div class="bg-[color:var(--rbb-header-background-color)]">
			<div id="desktop_menu" class="rbb-header-center lg:flex hidden items-center justify-center">
	...
	<div class="header-mobile relative bg-[color:var(--rbb-general-primary-color)] px-[15px] md:hidden">
