...
?>
<header id="rbb-default-header" class="rbb-default-header header-10 w-full relative z-20">
	<div class="rbb-header-sticky relative md:block hidden bg-[color:var(--rbb-menu-sticky-background-color)]">
		<div class="header-inner md:container mx-auto lg:h-[110px] md:h-[90px] h-[70px]">
		...
		<div class="bg-[color:var(--rbb-header-background-color)]">
			<div class="md:container mx-auto h-full ">
				<div id="desktop_menu" class="rbb-header-center lg:flex hidden items-center justify-center h-[70px]">
