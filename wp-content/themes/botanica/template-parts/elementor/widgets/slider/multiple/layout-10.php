				...
				<div class="block_slide">
					<div class="rbb-slick-carousel slick-carousel slick-carousel-center load-item-<?php echo esc_attr($sliders_to_show_default); ?>" data-slick='{
						...
						foreach ( $sliders as $slider ) {
							...
							?>
							<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?> mb-10 group duration-300">
								<div class="duration-300 border-b border-b-[#e5e5e5] border-r border-r-[#e5e5e5] hover:bg-[color:var(--rbb-general-primary-color)]">
									...
									?>
									<p class="text-[color:var(--rbb-general-primary-color)] group-hover:text-[color:var(--rbb-general-secondary-color)] font-bold duration-300 mb-2.5"><?php echo esc_html($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
