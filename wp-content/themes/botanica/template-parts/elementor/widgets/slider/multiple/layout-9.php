					...
					<div class="block_slide swiper-right overflow-hidden">
						...
						foreach ( $sliders as $slider ) {
							...
							<div class="swiper-slide">
								<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?> md:py-[60px] sm:py-5">
									<div class="block__content relative duration-300 text-center rounded-[26px] px-3 lg:px-4 pt-4 pb-[66px]">
										...
										<p class="text-center max-w-[260px] mb-0 inline-block"><?php echo esc_html($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
									<?php } ?>
										<?php
										if ( $button ) {
