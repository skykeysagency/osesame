						...
						foreach ( $sliders as $slider ) {
							...
							<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?> md:py-[60px] sm:py-10">
								<div class="block__content relative duration-300 text-center px-3 lg:px-4 pt-4">
									...
									<p class="text-center text-sm leading-6 <?php echo esc_attr($button ? 'pb-10' : 'mb-0'); ?> "><?php echo esc_html($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
