		...
		<div class="container mx-auto px-[15px] overflow-hidden">
			<div class="block_title text-center flex justify-center items-center">
				...
				<?php if ( $widget_title || $widget_sub_title ) { ?>
					<div class="title_block inline-block font-bold mb-[25px]">
						<?php
						if ( $widget_sub_title ) {
							?>
					...
					<div class="block_slide wow fadeInUp">
						...
						foreach ( $sliders as $slider ) {
							...
							<div class="item elementor-repeater-item-<?php echo esc_attr($slider['_id']); ?>">
								<div class="block__content relative duration-300  text-center px-3 pt-5">
									...
									<p class="text-center leading-6 mb-0"><?php echo esc_html($slider[ $slick->get_name_setting('multiple_content_description') ]); ?></p>
