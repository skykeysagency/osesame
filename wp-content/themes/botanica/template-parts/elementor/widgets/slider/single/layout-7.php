						...
						<div class="md:absolute md:py-0 pt-9 pb-6 top-0 w-full h-full">
							<div class="<?php echo esc_attr(( $parallax ) ? 'parallax' : ''); ?> m-auto relative h-full">
								...
								if ( $slider_title || $slider_sub_title || $description || $button_1 || $button_2 ) {
									...
									?>
									<div class="md:absolute info-wap xl:w-[760px] lg:w-[550px] md:w-1/2 z-50 <?php echo esc_attr($horizontal_align_class); ?> <?php echo esc_attr($vertical_align_class); ?>">
										<div class="info-inner lg:px-[30px] px-4">
											<?php
