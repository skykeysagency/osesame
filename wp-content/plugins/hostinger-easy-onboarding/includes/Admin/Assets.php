...
class Assets {
	...
	public function admin_scripts(): void {
        ...
        $global_data['ai_block_inject'] = [
            ...
            'ai_assistant' => (int)is_plugin_active( 'hostinger-ai-assistant/hostinger-ai-assistant.php' ),
            'affiliate_connector' => (int)is_plugin_active( 'hostinger-affiliate-plugin/hostinger-affiliate-plugin.php' ),
        ];
