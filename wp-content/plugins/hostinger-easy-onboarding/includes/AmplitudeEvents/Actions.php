...
class Actions {
    ...
    public const WP_REFERRAL_PROMOTION_SHOWN = 'wp_admin.referrals_promotion.shown';
    public const WP_REFERRAL_PROMOTION_SELECTED = 'wp_admin.referrals_promotion.selected';
    public const WP_REFERRAL_PROMOTION_CLOSED = 'wp_admin.referrals_promotion.closed';
